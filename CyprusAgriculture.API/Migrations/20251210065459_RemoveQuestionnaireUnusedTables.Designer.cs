...
namespace CyprusAgriculture.API.Migrations
{
    ...
    [Migration("20251210065459_RemoveQuestionnaireUnusedTables")]
    partial class RemoveQuestionnaireUnusedTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CyprusAgriculture.API.Models.InvitationBatch", b =>
                {
                    ...
                    b.Property<Guid>("InvitationTemplateId")
                        .HasColumnType("uuid")
                        .HasColumnName("invitation_template_id");
                    ...
                    b.Property<string>("RecipientFarms")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("recipient_farms");
                    ...
                    b.HasIndex("InvitationTemplateId")
                        .HasDatabaseName("ix_invitation_batches_invitation_template_id");
            ...
            modelBuilder.Entity("CyprusAgriculture.API.Models.Location", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "01",
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 651, DateTimeKind.Utc).AddTicks(3560),
                            IsActive = true,
                            Latitude = 35.1855659,
                        ...
                        new
                        {
                            ...
                            Code = "02",
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 653, DateTimeKind.Utc).AddTicks(10),
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            Code = "03",
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 653, DateTimeKind.Utc).AddTicks(109),
                            IsActive = true,
                        ...
                        new
                        {
                            ...
                            Code = "04",
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 653, DateTimeKind.Utc).AddTicks(114),
                            IsActive = true,
                            Latitude = 34.7766904,
                            LocationLevel = "location",
                        ...
                        new
                        {
                            ...
                            Code = "05",
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 653, DateTimeKind.Utc).AddTicks(119),
                            IsActive = true,
            ...
            modelBuilder.Entity("CyprusAgriculture.API.Models.Quota", b =>
                {
                    ...
                    b.HasIndex("QuestionnaireId", "Name")
                        .HasDatabaseName("ix_quotas_questionnaire_id_name");
            ...
            modelBuilder.Entity("CyprusAgriculture.API.Models.Theme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BodyFontSize = 14,
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 654, DateTimeKind.Utc).AddTicks(7968),
            ...
            modelBuilder.Entity("CyprusAgriculture.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 656, DateTimeKind.Utc).AddTicks(624),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 12, 10, 6, 54, 57, 656, DateTimeKind.Utc).AddTicks(5185),
            ...
            modelBuilder.Entity("CyprusAgriculture.API.Models.InvitationBatch", b =>
                {
                    b.HasOne("CyprusAgriculture.API.Models.InvitationTemplate", "InvitationTemplate")
                        .WithMany("InvitationBatches")
                        .HasForeignKey("InvitationTemplateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_invitation_batches_invitation_templates_invitation_template");
